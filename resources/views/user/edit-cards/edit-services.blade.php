            ...
            <div class="container-xl">
                <div class="row row-deck row-cards">
                    <div class="col-sm-12 col-lg-12">
                        <form class="card" action="{{ route('user.update.services', Request::segment(3)) }}"
                                            ...
                                            @for ($i = 0; $i < count($services); $i++)
                                                <div class='row' id="{{ $i }}">
                                                    ...
                                                    <div class="col-md-6 col-xl-6">
                                                        <div class="mb-3">
                                                            <label
                                                                class="form-label required">{{ __('Service Name') }}</label>
                                                    ...
                                                    <div class="col-md-6 col-xl-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" name="service_description[]"
                                                                type="text"
                                ...
                                <div class="col-md-4 col-xl-4 my-3">
                                    <div class="mb-3">
                                        <a class="btn btn-primary"
                                            href="{{ route('user.edit.galleries', Request::segment(3)) }}">
                                            {{ __('Skip & Continue') }}
                                        </a>
