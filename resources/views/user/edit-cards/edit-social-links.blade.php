            ...
            <div class="container-xl">
                <div class="row row-deck row-cards">
                    <div class="col-sm-12 col-lg-12">
                        <form class="card" action="{{ route('user.update.social.links', Request::segment(3)) }}"
                            method="post">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                                ...
                                                <div class='row' id="{{ $i }}">
                                                    ...
                                                    <div class='col-lg-2 col-md-2'>
                                                        <div class='mb-3 mt-2'>
                                                            ...
                                                            <select class='type{{ $features[$i]->id }} form-control'
                                                                id='type' name='type[]'
                                                    ...
                                                    <div class='col-lg-3 col-md-3'>
                                                        <div class='mb-3 mt-2'>
                                                            ...
                                                            <input class='lbl{{ $features[$i]->id }} form-control'
                                                    ...
                                                    <div class='col-lg-4 col-md-4'>
                                                        <div class='mb-3 mt-2'>
                                                            ...
                                                            <input class='textlbl{{ $features[$i]->id }} form-control'
        ...
        function addFeature() {
            ...
            if (count >= {{ $plan_details->no_of_features }}) {
                ...
                var features = "<div class='row' id=" + id +
                    ...
                    id +
                    " form-control' name='value[]' placeholder='{{ __('Type something') }}...' required></div></div><div class='col-lg-1 col-md-1'> <div class='mb-2 pt-1 mt-4'><button class='btn btn-transparent' onclick='removeFeature(" +
