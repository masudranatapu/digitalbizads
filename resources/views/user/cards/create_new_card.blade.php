                                        ...
                                        <div class="row row-cols-4 row-cols-sm-5 g-3">
                                            ...
                                            <div class="col">
                                                <div class="social_item">
                                                    <a class="social-contact phone_number" href="" target="_blank">
                                            ...
                                            <div class="col">
                                                <div class="social_item">
                                                    <a class="social-contact user_email" href="" target="_blank">
                                            ...
                                            <div class="col">
                                                <div class="social_item">
                                                    <a class="social-contact facebook" href="" target="_blank">
                                            ...
                                            <div class="col">
                                                <div class="social_item">
                                                    <a class="social-contact instagram" href="" target="_blank">
                            ...
                            <form id="card-form" action="{{ route('user.card.store') }}" method="post"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3 form-input">
                                            ...
                                            <input class="form-control @error('adsname') is-invalid @enderror"
                                                id="adsname" name="adsname" type="text" value="{{ old('adsname') }}"
                                                tabindex="{{ $tabindex++ }}" placeholder="ads name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 form-input">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('phone_number') }}" tabindex="{{ $tabindex++ }}"
                                    ...
                                    <div class="mb-3 form-input">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="headline"
                                                ...
                                                data-concat="preview_name" type="text" value="{{ old('text') }}"
                                                tabindex="{{ $tabindex++ }}" placeholder="Biz Ad Name">
                                            ...
                                            <input id="logofield"
                                                ...
                                                name="logo" type="file" tabindex="{{ $tabindex++ }}"
                                ...
                                <div class="col-12">
                                    <div class="mb-3 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-text p-0">
                                                <select class="form-control form-select border-0 " id="selectField2"
                                                    name="gallery_type" tabindex="{{ $tabindex++ }}" required
                                                    style="height: 43px !important;">
                                            ...
                                            {{-- video url --}}
                                            <input id="videourl"
                                                class="form-control d-none @error('video') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 form-input">
                                            ...
                                            <input
                                                ...
                                                id="website" id="company_websitelink" name="website" data-attr=""
                                                data-type="website" data-preview="preview_company_websitelink"
                                                type="url" value="{{ old('website') }}" tabindex="{{ $tabindex++ }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 form-input">
                                            ...
                                            <input
                                                ...
                                                type="url" value="{{ old('facebook') }}" tabindex="{{ $tabindex++ }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 form-input">
                                            ...
                                            <input
                                                ...
                                                type="url" value="{{ old('instagram') }}" tabindex="{{ $tabindex++ }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 form-input">
                                            ...
                                            <input class="form-control cin @error('cashapp') is-invalid @enderror"
                                                id="cashapp" name="cashapp" data-preview="preview_cashapp" type="text"
                                                value="{{ old('cashapp') }}" tabindex="{{ $tabindex++ }}"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 form-input">
                                        ...
                                        <input
                                            ...
                                            id="location" name="location" data-preview="preview_location" data-attr=""
                                            data-type="map" type="url" value="{{ old('location') }}"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 form-input">
                                        ...
                                        <textarea
                                            class="social_item_in form-control cin @error('about_us') is-invalid @enderror"
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="mb-3 input-group">
                                        ...
                                        <input type="text" name="base_link" id="base_link" class="form-control"
                                ...
                                <div class="col-12">
                                    <div class="mb-3 form-input position-relative">
                                        ...
                                        <input class="form-control cin @error('footer_text') is-invalid @enderror"
                                            ...
                                            type="text" tabindex="{{ $tabindex++ }}" placeholder="copyright" {{
                                        ...
                                        <div class="mb-3 form-input">
                                            ...
                                            <div class="input-group custome_color">
                                                <label class="input-group-text" for="header_backgroung">
                                                    <img src="{{ asset('images/color-picker.png') }}" alt="color picker"
                                                        width="25">
                                                    <input
                                                        class="form-control @error('header_backgroung') is-invalid @enderror"
                                                        id="header_backgroung" name="header_backgroung" type="color"
                                                        value="{{ old('header_backgroung') ?? ' #ffc107' }}"
                                                        tabindex="{{ $tabindex++ }}" placeholder="card color" required>
                                                </label>
                                            ...
                                            <div class="input-group custome_color">
                                                <label class="input-group-text" for="header_text_color">
                                                    ...
                                                    <input
                                                        ...
                                                        id="header_text_color" name="header_text_color" type="color"
                                            ...
                                            <div class="input-group custome_color">
                                                <label class="input-group-text" for="icon_border_color">
                                                    ...
                                                    <input
                                                        ...
                                                        id="icon_border_color" name="icon_border_color" type="color"
                                                        value="{{ old('icon_border_color') ?? ' #ffc107' }}"
                                                        tabindex="{{ $tabindex++ }}" placeholder="card color" required>
                                                </label>
                                                <input class="form-control" id="icon_border_color_code" type="text"
                                                    value="#ffc107" disabled>
                                            </div>
