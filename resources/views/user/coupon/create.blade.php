                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" required name="name" placeholder=" name" autocomplete="off">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="">Code <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control @error('code') is-invalid @enderror" required name="code" placeholder="Code" autocomplete="off">
                                        </div>
