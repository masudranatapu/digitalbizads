    ...
    <center style="width: 100%; background-color: #f1f1f1;">
        ...
        <div class="email-container" style="max-width: 800px; margin: 0 auto;">
            ...
            <table role="presentation" style="margin: auto;" align="center" cellspacing="0" cellpadding="0"
                            ...
                            <tr>
                                <td class="logo" style="text-align: left;">
                                    <h1>
                                        ...
                                        <P>Hello {{ $businessCard->hasUser->name }},
                                            You have a order in your store.
                                        </P>
                                    </h1>
                                </td>
                            </tr>
                ...
                <tr>
                    <td class="hero bg_white" style="padding: 2em 0 2em 0; color:#000;" valign="middle">
                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="width: 50%; padding: 1em 2.5em 0 2.5em; vertical-align: top">
                ...
                <tr>
                    <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                            <th style="text-align:left; padding: 0 2.5em; color: #000; padding-bottom: 20px"
                                width="60%">Item</th>
                            <th style="text-align:right; padding: 0 2.5em; color: #000; padding-bottom: 20px"
                                width="10%">Quantity</th>
                            <th style="text-align:right; padding: 0 2.5em; color: #000; padding-bottom: 20px"
                                width="10%">Price</th>
                            <th style="text-align:right; padding: 0 2.5em; color: #000; padding-bottom: 20px"
                                width="20%">Sub-Total</th>
                        </tr>
                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                <td style="text-align:left;" valign="middle">
                                    <div class="product-entry">
                                        ...
                                        <div class="text">
                                            <h3>{{ $orderDetails->hasProduct->product_name }}</h3>
                                ...
                                <td style="text-align:center;" valign="middle">
                                    <span class="price"
                                        style="color: #000; font-size: 20px;">{{ getPrice($orderDetails->unit_price) }}</span>
                                </td>
                                <td style="text-align:center;" valign="middle">
                                    <span class="price"
                                        style="color: #000; font-size: 20px;">{{ getPrice($line_total) }}</span>
                                </td>
                            </tr>
                        @endforeach
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <p style="text-align:center;color:#000;">
                                    <span>{{ getPrice($order->shipping_cost) }}</span>
                                </p>
                            </td>
                        </tr>
                        <tr>
