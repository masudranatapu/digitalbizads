                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td class="logo" style="text-align: left;">
                                    <h1><a href="{{ route('home-locale') }}">{{ $settings->site_name }}</a></h1>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                <td style="padding: 0 2.5em; text-align: left;">
                                    <div class="text">
                                        ...
                                        <h3>You have a new order.Here some of his details.</h3>
                        ...
                        @foreach ($cart as $cartItem)
                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                ...
                                <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
                                    <span class="price"
                                        style="color: #000; font-size: 20px;">{{ $cartItem['qty'] * $cartItem['price'] }}
                                        {{ $cartItem['currency'] }}</span>
                                </td>
                            </tr>
                        @endforeach
