@extends('layouts.web', ['nav' => true, 'banner' => false, 'footer' => true, 'cookie' => true, 'setting' => true, 'title' => __('JS Minifier - Web Tools')])
            ...
            <div class="container px-5 py-24 mx-auto">
                ...
                <form action="{{ route('web.result.js.minifier') }}" method="post">
                    ...
                    <div class='mb-3 space-y-2 w-full'>
                        <label class='font-bold text-gray-600 py-2'>{{ __('JS Code') }} <abbr
                        ...
                        <textarea
                            ...
                            id="js" name="js" cols="30" rows="10" placeholder="{{ __('JS Code') }}">
@isset($js)
{{ $js }}
@endisset
</textarea>
