@extends('layouts.web', ['nav' => true, 'banner' => false, 'footer' => true, 'cookie' => true, 'setting' => true, 'title' => __('JS Beautifier - Web Tools')])
            ...
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class='mb-3 space-y-2 w-full'>
                    ...
                    <textarea
                        ...
                        id="js" name="js" cols="30" rows="10" placeholder="{{ __('JS Code') }}"></textarea>
                </div>
