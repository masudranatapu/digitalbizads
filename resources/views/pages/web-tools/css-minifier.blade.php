@extends('layouts.web', ['nav' => true, 'banner' => false, 'footer' => true, 'cookie' => true, 'setting' => true, 'title' => __('CSS Minifier - Web Tools')])
            ...
            <div class="container px-5 py-24 mx-auto">
                ...
                <form action="{{ route('web.result.css.minifier') }}" method="post">
                    ...
                    <div class='mb-3 space-y-2 w-full'>
                        <label class='font-bold text-gray-600 py-2'>{{ __('CSS Code') }} <abbr
                        ...
                        <textarea
                            ...
                            id="css" name="css" cols="30" rows="10" placeholder="{{ __('CSS Code') }}">
@isset($css)
{{ $css }}
@endisset
</textarea>
                    ...
                    <button
                        ...
                        type="submit" onclick="convert()">{{ __('Convert') }}</button>
                </form>
                ...
                @if (isset($results))
                    <div class='mb-3 space-y-2 w-full'>
                        ...
                        <textarea
                            class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter font-mono text-base text-black rounded-lg h-48 px-4 py-2"
                            id="result" name="result" cols="30" rows="10" placeholder="{{ __('Output') }}">{{ $results }}</textarea>
                    </div>
