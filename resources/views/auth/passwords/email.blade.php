                ...
                <div>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="px-3 text-center">
                            <button
                                class="mb-2 w-full py-4 bg-{{ $config[11]->config_value }}-600 hover:bg-{{ $config[11]->config_value }}-700 rounded text-lg font-bold text-gray-50 transition duration-200">{{ __('Send Password Reset Link') }}</button>
                        </div>
                    </form>
                </div>
            </div>
